        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800">
                    <i class="fa-solid fa-plus mr-2 text-nature-600"></i>เพิ่มท่าบริหารใหม่
                </h2>
                <p class="text-sm text-gray-500 mt-1">เพิ่มท่าบริหารเข้าคลังวัสดุเพื่อให้นักกายภาพฯ สามารถเลือกสั่งจ่ายให้คนไข้</p>
            </div>
        </div>
    </x-slot>
        ...
        <form method="POST" action="{{ route('admin.exercise-libraries.store') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="3"
                                          class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-nature-300"
                                          placeholder="อธิบายรายละเอียดของท่าบริหาร...">{{ old('description') }}</textarea>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="instructions" rows="5"
                                          class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-nature-300"
                                          placeholder="อธิบายขั้นตอนการทำท่าบริหาร&#10;1. ...&#10;2. ...">{{ old('instructions') }}</textarea>
                            </div>
                            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">URL วิดีโอ (YouTube, Vimeo)</label>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div x-data="{ preview: null, fileName: '' }" class="space-y-3">
                            <div @click="$refs.fileInput.click()"
                                 class="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center cursor-pointer hover:border-nature-400 hover:bg-nature-50/30 transition"
            ...
            <div class="mt-6 flex items-center justify-end gap-3">
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-floppy-disk mr-2"></i>บันทึกท่าบริหาร
                </button>
            </div>
        </form>
    </div>
